    ...
    <div class="articles-main 
        ...
        <?php foreach($items as $item){ ?>
			...
			<div class="content_list_item articles_list_item
                ...
                <div class="fields g-pl_5 g-pr_5">
                    ...
                    <div class="field ft_caption f_title
                        ...
                        <?php if ($field['name'] == 'title' && $ctype['options']['item_on']){ ?>
                            ...
                            <?php if ($item['parent_id']){ ?>
                                <a class="g-ff_reg g-c_dk_blue g-pt_15 g-d_ib g-fz_1_8r g-td_n g-lh_2_6r" href="<?php echo rel_to_href($item['parent_url']); ?>"><?php html($item['parent_title']); ?></a>
                                &rarr;
                            <?php } ?>
                            ...
                            <?php } else { ?>
                                <a class="g-ff_reg g-c_dk_blue g-pt_15 g-d_ib g-fz_1_8r g-td_n g-lh_2_6r" href="<?php echo href_to($ctype['name'], $item['slug'].'.html'); ?>"><?php html($item[$field['name']]); ?></a>
                        ...
                        <?php } else { ?>
                            <div class="">
                                ...
                                <?php } else { ?>
                                    <div class='g-ff_lt g-c_dim_dk_blue g-fz_1_6r g-lh_2_3r'>
                                    <?php echo $field['html']; ?>
                                    </div>
                                <?php } ?>
                            </div>
