...
<div class='p-page-title-main
                g-pl_10 g-pt_40 g-pb_30'>
    <h1 class='g-lh_3_5r g-va_m g-d_ib g-ff_lt g-c_dk_blue g-fz_2_4r'>
        <?php html($item['title']); ?>
                ...
                <?php foreach ($fieldset['fields'] as $name => $field) { ?>
                    ...
                    switch ($field['title']) {
                        case "container_start":?>
                            <div class="<?php echo $field['html']; ?>">
                            <?php break;
                        case "container_end":?>
                            </div>
                            <?php break;
                        default:?>
                            <div class="field11 ft_<?php echo $field['type']; ?> f_<?php echo $field['name']; ?> <?php echo $field['options']['wrap_type']; ?>_field" <?php if($field['options']['wrap_width']){ ?> style="width: <?php echo $field['options']['wrap_width']; ?>;"<?php } ?>>
